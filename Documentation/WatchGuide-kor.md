xDrip+ Wear 설정 및 Troubleshooting 가이드 (작성중)
======================================
**Table of Contents**
...
# xDrip+ Android Wear 통합 가능 
xDrip+ 는 wear 통합을 wear app 을 통해 지원하고 있습니다. 
xDrip+ wear 앱은 standard xDrip+ api로 설치 됩니다. 
**Android Wear 1.x** 워치 종류들은 웨어 컴포넌트가 워치에 자동으로 동기화 됩니다. 
**Android Wear 2.0** 워치 종류들은 폰에 xDrip+ 설치후에 ("Apps on your phone" 섹션 하위)에 있는 플레이 스토어에서 별도로 웨어 컴포넌트를 설치(활성화가) 가 필요합니다. 
최종 릴리즈는 스탠드 얼론 모드를 지원합니다. 이것은 웨어 앱이 직접적으로 블루투스 컬렉터(Dexcom G5, Dexcom G5 + xBridge, Dexcom Share 혹은 Libre LimitTTer)와 통신할 수 있도록 해줍니다. 

wear 스탠드 얼론 기능은 아래 xDrip+ 세팅을 통해서 가능합니다. 이 기능은 **Smart Watch Features** 하위에 위치합니다. 그리고 **XDrip Prefs** 설정에 동작합니다. 

<img align="middle" src="./images/prefs-wear-sync.png" title="xDrip+ Wear Integration Preferences">

|폰 설정                                 | Watch Settings   | 설명                     |
| ------------------------------------ | ---------------- | ------------------------|
| Android Wear Integration             | NA               | 웨어 인터렉션을 가능하게 합니다.|
